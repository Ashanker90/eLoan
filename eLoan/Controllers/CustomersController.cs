...
namespace eLoan.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("customer_ID,application_ID,profile_ID,loan_ID")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("customer_ID,application_ID,profile_ID,loan_ID")] Customer customer)
        {
